...
class WinGUI(Tk):
    def __init__(self):
        ...
        self.tk_button_m4m39mdu = self.__tk_button_m4m39mdu(self)
        self.tk_button_m4m3a8k7 = self.__tk_button_m4m3a8k7(self)
    def __win(self):
    ...
    def __tk_label_frame_m4kxyyht(self,parent):
        ...
        frame.place(x=5, y=50, width=755, height=460)
        return frame
    ...
    def __tk_label_frame_m4ky4w2t(self,parent):
        ...
        frame.place(x=5, y=520, width=755, height=375)
        return frame
    ...
    def __tk_label_m4kycih3(self,parent):
        ...
        label.place(x=330, y=10, width=100, height=30)
        return label
...
class Win(WinGUI):
    ...
    def __event_bind(self):
        self.tk_button_m4m39mdu.bind('<Button-1>',self.ctl.import_segments)
        self.tk_button_m4m3a8k7.bind('<Button-1>',self.ctl.import_cities)
        pass
