...
def export_area_codes():
    ...
    with open(file_name, "w", encoding="utf-8") as f:
        f.write(",".join(area_codes))
    messagebox.showinfo("成功", f"区号已导出到 {file_name}")
...
export_button = tk.Button(button_frame, text="导出区号", command=export_area_codes)
